...
function loading() {
    ...
    loadingImage.src = 'https://cdn.sr-1.tk/img/loadingSprite.png';
    loadingImage.onload = function (event) {
        ...
        //
        manifest = [
            {src: "https://cdn.sr-1.tk/img/background-loading.jpg", id: "background-loading"},
            {src: "https://cdn.sr-1.tk/img/background-login.jpg", id: "background-login"},
            {src: "https://cdn.sr-1.tk/css/login.css", id: "css-login"},
