...
function loading() {
    ...
    loadingImage.src = 'https://dl.dropboxusercontent.com/u/14626206/isil/assets/img/loadingSprite.png';
    loadingImage.onload = function (event) {
        ...
        //
        manifest = [
            {src: "https://dl.dropboxusercontent.com/u/14626206/isil/assets/img/background-loading.jpg", id: "background-loading"},
            {src: "https://dl.dropboxusercontent.com/u/14626206/isil/assets/img/background-login.jpg", id: "background-login"},
            {src: "https://dl.dropboxusercontent.com/u/14626206/isil/assets/css/login.css", id: "css-login"},
